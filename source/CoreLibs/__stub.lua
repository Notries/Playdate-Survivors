...
function playdate.table.indexOfElement(table, element) end
function playdate.table.getsize(table) end
function playdate.table.create(arrayCount, hashCount) end
function playdate.table.shallowcopy(source, destination) end
function playdate.table.deepcopy(source) end
...
function playdate.graphics.sprite:setStencilPattern_p(pattern) end
...
function playdate.json.decodeFile(file) end
function playdate.json.encode(table) end
function playdate.json.encodePretty(table) end
function playdate.json.encodeToFile(file) end
...
function playdate.sound.synth.new_w(waveform) end
...
function playdate.sound.synth:setWavetable(sample, samplesize, rowwidth) end
...
function playdate.timer.paused() end
...
function playdate.ui.crankIndicator:reset() end
